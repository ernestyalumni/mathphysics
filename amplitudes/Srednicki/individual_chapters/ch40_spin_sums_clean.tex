...
= \frac{1}{4}\,\Tr\bigl[(\slashed{p}_1+m)\gamma^\mu(\slashed{p}_2+m)\gamma^\nu\bigr]\;
\Tr\bigl[(\slashed{p}_3+m')\gamma_\mu(\slashed{p}_4+m')\gamma_\nu\bigr] .
\tag{40.1}
\end{equation}
\end{mdframed}
...
\begin{equation}
\Tr[(\slashed{p}_1+m)\gamma^\mu(\slashed{p}_2+m)\gamma^\nu]
= 2\Bigl[p_1^\mu p_2^\nu + p_1^\nu p_2^\mu
