...
\subsubsection{3 examples of Galilean transformations}
...
Introduce $E^3$ a "fixed" reference frame by fixing pt. $o \in E^3$ and choosing e mutually perpendicular axes.
