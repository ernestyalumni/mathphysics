...
\Longrightarrow \mathbf{v}_g = \mathbf{\omega} \times \mathbf{y} + g_t \mathbf{v}_{\mathbf{x}}
\end{gathered}
\]
...
\end{aligned}
\end{equation}
This is essentially Eqns. (7.28), (7.29)  Hand and Finch (1998) \cite{HaFi1998}. 
...
\]
As important point is that tangent vector $\dot{g}_t$ is represented by \textbf{left-invariant} form
\[
