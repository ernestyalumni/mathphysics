...
\boxed{ 
	...
	a \equiv b \bmod{m} \\
	\text{ meaning } \\ 
	\frac{a-b}{N} \in \mathbb{Z} \text{ or }  a- b =kN, \  k\in \mathbb{Z} \text{ or } a  = b+kN
	\end{gathered}	
}
\end{equation}
...
\exercisehead{1.19}
If $a$ and $b$ are relativel prime and if each divides an integer $n$, then their product $ab$ also divides $n$, i.e. 
